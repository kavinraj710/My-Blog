...
namespace BlogApplication.Services
{
    class AuthenticationProvider : AuthenticationStateProvider
    {
        ...
        {
            var token = await _jsRuntime.InvokeAsync<string>("CookieReader.Read", "authToken");
            ...
            var key = Encoding.ASCII.GetBytes("9IMZpp7HIGch/fnVPALNe/uf6QqiOgjzjRsiCXA6wXHcij9ZMyawpVbFbgGB688tnO239HrsbFh0t5aI2U7bAg==");
            ...
            try
            {
                var validationParameters = new TokenValidationParameters
                {
                    ...
                    ValidateIssuer = true,
                    ValidIssuer = "https://ktxqkibjwpocicuonflp.supabase.co/auth/v1",
